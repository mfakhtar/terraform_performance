...
perform_tasks() {
    ...
    local script_path="/Users/mohdfawazakhtar/terraform-cloud/terraform_performance/new_test/output_block/for_each/main.tf"
    ...
    terraform apply --auto-approve -target random_pet.example
