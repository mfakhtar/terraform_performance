...
perform_tasks() {
    ...
    local script_path="/Users/mohdfawazakhtar/terraform-cloud/terraform_performance/scripts/increase_resources/script1.sh"
...
#    mkdir "$folder_name"
    ...
    cp "$script_path" .
    bash script1.sh $((resource_count + 1)) $((resource_count + resource_count))
